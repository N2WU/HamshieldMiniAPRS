 ...
 * `KE8JCT,TQ2S3S,:/092345z4903.50N/07201.75W>Test1234
 * 
 * `APZGPS,KE8JCT-15,:/160130z4903.50N/07201.75W>Test1234
 * 
 */
...
AFSK afsk;
String messagebuff = "";
String origin_call = "APZGPS";
String destination_call = "KE8JCT";
String textmessage = "/160130z4903.50N/07201.75W>Test1234";
int msgptr = 0;
...
void setup() {
  ...
  radio.initialize();
  radio.frequency(144340); // default aprs frequency in North America
  radio.setRfPower(0);
